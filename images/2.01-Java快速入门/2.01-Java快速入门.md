...
[5.4- switch- case -default语句](#55-4)
...
- [http://www.yiibai.com/java/what-is-needed-to-get-started-with-java.html](http://www.yiibai.com/java/what-is-needed-to-get-started-with-java.html)

## 2- 创建一个工程

首先，我们使用Eclipse（注意就是Eclise，如果没有安装好，选安装好再接着下一个步骤）创建一个新的项目，这将在本教程中使用。

![img](index_files/1-160221122921109.png)
输入项目名称：

- **BasicJavaTutorial**

![img](index_files/1-16022112294B49.png)
项目已创建：
![img](index_files/1-16022112300a31.png)

注：为了能够在除英语工程其他语言可以使用，应该切换到UTF-8编码。

右键单击该项目并选择属性：
![img](index_files/1-160221123032O7.png)
![img](index_files/1-16022112304GK.png)
...
![img](index_files/1-16022112320NK.png)

新建命名包是：

- com.yiibai.tutorial.javabasic.variable
  ![img](index_files/1-160221123416442.png)

输入类的名称：

- **VariableExample1![img](index_files/1-160221123444918.png)**

创建 VariableExample1 类如下：

![img](index_files/1-16022112351C96.png)
...
![img](index_files/1-160221123600H9.png)

运行类，在控制台上看到的结果如下：
![img](index_files/1-16022112361c26.png)

您也可以一次声明多个变量，下例说明了这一点：

创建一个新的类 **VariableExample2![img](index_files/1-160221123954609.png)**
...
![img](index_files/1-160221124015Z7.png)
...
![img](index_files/1-160221124123494.png)
...
![img](index_files/1-16022112420YO.png)
